...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        // tests
        { pattern: "spec/tests/graphics/shape/point.spec.ts" },
        { pattern: "spec/tests/graphics/shape/line.spec.ts" },
        { pattern: "spec/tests/graphics/shape/triangle.spec.ts" },
        { pattern: "spec/tests/graphics/shape/rectangle.spec.ts" },
        { pattern: "spec/tests/graphics/shape/hexagon.spec.ts" },
        { pattern: "spec/tests/graphics/shape/octogon.spec.ts" },
        { pattern: "spec/tests/graphics/shape/ellipse.spec.ts" },
        { pattern: "spec/tests/graphics/shape/box.spec.ts" },
