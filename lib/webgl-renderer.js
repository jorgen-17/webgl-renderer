...
const boundingRectangle_1 = __webpack_require__(19);
...
const cuid = __webpack_require__(14);
const float32Vector_1 = __webpack_require__(9);
const glBufferWrapper_1 = __webpack_require__(16);
...
const slice = __webpack_require__(34);
const float32ArrayUtils_1 = __webpack_require__(42);
class Float32Vector {
...
const ellipse_1 = __webpack_require__(18);
const triangle_1 = __webpack_require__(21);
const rectangle_1 = __webpack_require__(22);
const hexagon_1 = __webpack_require__(23);
const octogon_1 = __webpack_require__(24);
const precision_1 = __webpack_require__(20);
const box_1 = __webpack_require__(25);
class ShapeFactory {
...
const renderModeMapper_1 = __webpack_require__(7);
const constants_1 = __webpack_require__(1);
const shaderSettings_1 = __webpack_require__(31);
const shaderType_1 = __webpack_require__(32);
const settings_1 = __webpack_require__(4);
const browserHelper_1 = __webpack_require__(15);
const pointBuffer_1 = __webpack_require__(33);
const vertexBuffer_1 = __webpack_require__(43);
class WebGLRenderer {
...
class ShapeFactory2d extends shapeFactory_1.ShapeFactory {
    createPoint(location, gl, rgbColor, pointSize) {
        const locationVec3 = new cuon_matrix_ts_1.Vec3(location.x, location.y, 0);
    ...
    createShape(point1, point2, shapeMode, gl, rgbColor, somenum) {
        const point1Vec3 = new cuon_matrix_ts_1.Vec3(point1.x, point1.y, 0);
        const point2Vec3 = new cuon_matrix_ts_1.Vec3(point2.x, point2.y, 0);
        switch (shapeMode) {
            case "points":
...
const point_1 = __webpack_require__(11);
const line_1 = __webpack_require__(12);
class ShapeFactory3d extends shapeFactory_1.ShapeFactory {
    createPoint(location, gl, rgbColor, pointSize) {
...
const mouseHelper_1 = __webpack_require__(46);
...
class WebGLRenderer2d extends webglRenderer_1.WebGLRenderer {
    constructor(canvas, renderingOptions = {}) {
        ...
        this._shapeFactory = new shapeFactory2d_1.ShapeFactory2d();
    }
    get shapeFactory() {
...
class WebGLRenderer3d extends webglRenderer_1.WebGLRenderer {
    constructor(canvas, renderingOptions = {}) {
        ...
        this._shapeFactory = new shapeFactory3d_1.ShapeFactory3d();
    }
    get camera() {
        return this._camera;
    }
