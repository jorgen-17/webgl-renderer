...
Object.defineProperty(exports, "__esModule", { value: true });
var webglRenderer_1 = __webpack_require__(20);
...
var pointBuffer_1 = __webpack_require__(32);
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.setupGlResources = function () {
        ...
        this.initShaders(this._dynamicVertexShaderSource, this._fragmentShaderSource, this._dynamicShapeShaderProgram);
        this.initShaders(this._pointVertexShaderSource, this._fragmentShaderSource, this._pointShaderProgram);
    };
    ...
    WebGLRenderer.prototype.getPointShaderVariables = function () {
        ...
        this._a_pointSize = this.gl.getAttribLocation(this._pointShaderProgram, shaderSettings_1.ShaderSettings.positionAttributeName);
    };
    ...
    WebGLRenderer.prototype.initShaders = function (vertexSource, fragmentSource, shaderProgram) {
