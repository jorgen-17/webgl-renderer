...
Object.defineProperty(exports, "__esModule", { value: true });
var boundingRectangle_1 = __webpack_require__(17);
...
Object.defineProperty(exports, "__esModule", { value: true });
var cuid = __webpack_require__(31);
var float32Vector_1 = __webpack_require__(9);
var glBufferWrapper_1 = __webpack_require__(15);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ellipse_1 = __webpack_require__(16);
var triangle_1 = __webpack_require__(19);
var rectangle_1 = __webpack_require__(20);
var hexagon_1 = __webpack_require__(21);
var octogon_1 = __webpack_require__(22);
var precision_1 = __webpack_require__(18);
var box_1 = __webpack_require__(23);
...
var renderModeMapper_1 = __webpack_require__(7);
var constants_1 = __webpack_require__(1);
var shaderSettings_1 = __webpack_require__(28);
var shaderType_1 = __webpack_require__(29);
var settings_1 = __webpack_require__(4);
var browserHelper_1 = __webpack_require__(14);
var pointBuffer_1 = __webpack_require__(30);
...
Object.defineProperty(exports, "__esModule", { value: true });
var webgl2dRenderer_1 = __webpack_require__(27);
exports.WebGL2dRenderer = webgl2dRenderer_1.WebGL2dRenderer;
var webgl3dRenderer_1 = __webpack_require__(43);
exports.WebGL3dRenderer = webgl3dRenderer_1.WebGL3dRenderer;
var cuon_matrix_ts_1 = __webpack_require__(0);
exports.Vec2 = cuon_matrix_ts_1.Vec2;
exports.Vec3 = cuon_matrix_ts_1.Vec3;
exports.Mat4 = cuon_matrix_ts_1.Mat4;
var rgbColor_1 = __webpack_require__(25);
...
var cuon_matrix_ts_1 = __webpack_require__(0);
var WebGL2dRenderer = (function (_super) {
    __extends(WebGL2dRenderer, _super);
    function WebGL2dRenderer(canvas, renderingOptions) {
        if (renderingOptions === void 0) { renderingOptions = {}; }
        var _this = _super.call(this, canvas, renderingOptions) || this;
        _this._shapeFactory = new shapeFactory2d_1.ShapeFactory2d();
        return _this;
    }
    Object.defineProperty(WebGL2dRenderer.prototype, "shapeFactory", {
        get: function () {
    ...
    WebGL2dRenderer.prototype.addShapeToScene = function (shape) {
    ...
    WebGL2dRenderer.prototype.addHomogenoeusShapesArrayToScene = function (shapes) {
        var shape = shapes[0];
        if (!shape) {
            return new Array();
        }
    ...
    WebGL2dRenderer.prototype.addVertexToScene = function (position, renderMode, color) {
    ...
    WebGL2dRenderer.prototype.removeShape = function (id, shapeMode) {
        switch (shapeMode) {
            case "points":
    ...
    WebGL2dRenderer.prototype.updateShapeColor = function (id, newColor, shapeMode) {
        switch (shapeMode) {
            case "points":
    ...
    WebGL2dRenderer.prototype.drawPointShapeBuffer = function (shapeBuffer) {
        this.drawPointShapeBufferBase(shapeBuffer);
    };
    WebGL2dRenderer.prototype.drawDynamicShapeBuffer = function (shapeBuffer) {
        this.drawDynamicShapeBufferBase(shapeBuffer);
    };
    WebGL2dRenderer.prototype.drawVertexBuffer = function (vertexBuffer) {
        this.drawVertexBufferBase(vertexBuffer);
    };
    WebGL2dRenderer.prototype.initializaDynamicShapeBuffers = function () {
...
var WebGL3dRenderer = (function (_super) {
    __extends(WebGL3dRenderer, _super);
    function WebGL3dRenderer(canvas, renderingOptions) {
        if (renderingOptions === void 0) { renderingOptions = {}; }
        var _this = _super.call(this, canvas, renderingOptions) || this;
    ...
    Object.defineProperty(WebGL3dRenderer.prototype, "camera", {
        get: function () {
            return this._camera;
        },
        set: function (value) {
    ...
    Object.defineProperty(WebGL3dRenderer.prototype, "shapeFactory", {
        get: function () {
            return this._shapeFactory;
        },
        enumerable: true,
    ...
    WebGL3dRenderer.prototype.addShapeToScene = function (shape) {
        switch (shape.shapeMode) {
            case "points":
                return this._pointsShapeBuffer.addShape(shape);
            case "triangles":
    ...
    WebGL3dRenderer.prototype.addHomogenoeusShapesArrayToScene = function (shapes) {
        var shape = shapes[0];
        if (!shape) {
            return new Array();
        }
    ...
    WebGL3dRenderer.prototype.addVertexToScene = function (position, renderMode, color) {
        this.addVertexToSceneBase(position, renderMode, color);
    };
    WebGL3dRenderer.prototype.removeShape = function (id, shapeMode) {
        switch (shapeMode) {
            case "points":
                return this._pointsShapeBuffer.removeShape(id);
            case "triangles":
    ...
    WebGL3dRenderer.prototype.updateShapeColor = function (id, newColor, shapeMode) {
        switch (shapeMode) {
            case "points":
                return this._pointsShapeBuffer.updateColor(id, newColor);
            case "triangles":
    ...
    WebGL3dRenderer.prototype.drawPointShapeBuffer = function (shapeBuffer) {
        this.drawPointShapeBufferBase(shapeBuffer, this._camera.vpMatrix);
    };
    WebGL3dRenderer.prototype.drawDynamicShapeBuffer = function (shapeBuffer) {
        this.drawDynamicShapeBufferBase(shapeBuffer, this._camera.vpMatrix);
    };
    WebGL3dRenderer.prototype.drawVertexBuffer = function (vertexBuffer) {
        this.drawVertexBufferBase(vertexBuffer, this._camera.vpMatrix);
    };
    WebGL3dRenderer.prototype.initializaDynamicShapeBuffers = function () {
        this._trianglesShapeBuffer = new shapeBuffer_1.ShapeBuffer(this.gl);
        this._rectanglesShapeBuffer = new shapeBuffer_1.ShapeBuffer(this.gl);
        this._hexagonsShapeBuffer = new shapeBuffer_1.ShapeBuffer(this.gl);
        this._octogonsShapeBuffer = new shapeBuffer_1.ShapeBuffer(this.gl);
