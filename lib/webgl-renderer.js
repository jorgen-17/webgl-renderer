...
var point3d_1 = __webpack_require__(7);
...
var drawingMode_1 = __webpack_require__(18);
var camera_1 = __webpack_require__(6);
var point3d_1 = __webpack_require__(7);
var settings_1 = __webpack_require__(5);
var WebGLRenderer = (function () {
    function WebGLRenderer(canvasWidth, canvasHeight, gl, backgroundColor, color, camera) {
    ...
    WebGLRenderer.prototype.translateCamera = function (eyePosition) {
        this._eyePosition = eyePosition;
        this._lookAtPoint = new point3d_1.Point3d(eyePosition.x, eyePosition.y, eyePosition.z - 1);
        this._upPosition = new point3d_1.Point3d(eyePosition.x, eyePosition.y + 1, eyePosition.z);
    ...
    WebGLRenderer.prototype.initializeRenderingProperties = function (backgroundColor, color) {
    ...
    WebGLRenderer.prototype.initializeCamera = function (camera) {
        if (camera) {
            ...
            this._camera = new camera_1.Camera(this._eyePosition, this._lookAtPoint, this._upPosition);
        }
        else {
            this._eyePosition = new point3d_1.Point3d(0, 0, 0);
            this._lookAtPoint = new point3d_1.Point3d(0, 0, -1);
            this._upPosition = new point3d_1.Point3d(0, 1, 0);
            this._camera = new camera_1.Camera(this._eyePosition, this._lookAtPoint, this._upPosition);
        }
    };
    ...
    WebGLRenderer.prototype.drawGlArray = function (vector, renderMode) {
        ...
        var u_viewMatrix = this.gl.getUniformLocation(this._shaderProgram, "u_viewMatrix");
        if (!u_viewMatrix) {
        ...
        this.gl.vertexAttribPointer(a_position, settings_1.Settings.floatsPerPoint, this.gl.FLOAT, false, floatSize * 5, 0);
        this.gl.enableVertexAttribArray(a_position);
        this.gl.vertexAttribPointer(a_color, settings_1.Settings.floatsPerColor, this.gl.FLOAT, false, floatSize * 5, floatSize * 2);
        this.gl.enableVertexAttribArray(a_color);
        this.gl.uniformMatrix4fv(u_viewMatrix, false, this._camera.getViewMatrix());
        this.gl.drawArrays(renderMode, 0, (vector.size / settings_1.Settings.floatsPerVertex));
    };
...
var VertexBuffer = (function () {
    ...
    VertexBuffer.prototype.addVertex = function (vertex) {
        ...
        if (this._topVertexVector.arr.length + vertex.length < settings_1.Settings.vertexBufferFloatLimit) {
