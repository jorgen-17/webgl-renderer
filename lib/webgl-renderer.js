...
var Shape2d = (function () {
    ...
    Shape2d.prototype.addTriangleToFloat32Array = function (array, index, vertex1Position, vertex2Position, vertex3Position) {
        ...
        this.addXYZAndColorToFloat32Array(array, (index + settings_1.Settings.floatsPerVertex), vertex2Position.x, vertex2Position.y, vertex2Position.z);
        this.addXYZAndColorToFloat32Array(array, (index + (settings_1.Settings.floatsPerVertex * 2)), vertex3Position.x, vertex3Position.y, vertex3Position.z);
    };
    return Shape2d;
}());
...
var Ellipse = (function (_super) {
    ...
    Ellipse.prototype.computeVerticies = function () {
        ...
        for (var i = 0; i < (numberOfPointsAlongTheCurve / 2) - 1; i++) {
            ...
            insertionIndex += settings_1.Settings.floatsPerTriangle;
    ...
    Ellipse.highPrecisionNumberOfVerticies = Ellipse.highPrecisionNumberOfPointsAlongCurve * settings_1.Settings.verticiesPerTriangle;
    Ellipse.lowPrecisionNumberOfPointsAlongCurve = 8 + Ellipse.numberOfEndPoints;
    Ellipse.lowPrecisionNumberOfVerticies = Ellipse.lowPrecisionNumberOfPointsAlongCurve * settings_1.Settings.verticiesPerTriangle;
    return Ellipse;
}(shape2d_1.Shape2d));
