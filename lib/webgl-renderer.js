...
var precision_1 = __webpack_require__(8);
var settings_1 = __webpack_require__(0);
var Ellipse = (function (_super) {
    ...
    Ellipse.prototype.computeVerticies = function () {
        ...
        this.addXYZAndColorToFloat32Array(arr, (arr.length - settings_1.Settings.floatsPerVertex), endPointX, endPointY, this.center.z);
...
var Triangle = (function (_super) {
    ...
    Triangle.prototype.computeVerticies = function () {
        ...
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.bottomLeft.x, this.boundingRect.bottomLeft.y, this.boundingRect.bottomLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, topPoint.x, topPoint.y, topPoint.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.bottomRight.x, this.boundingRect.bottomRight.y, this.boundingRect.bottomRight.z);
...
var Rectangle = (function (_super) {
    ...
    Rectangle.prototype.computeVerticies = function () {
        ...
        var insertionIndex = 0;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.topLeft.x, this.boundingRect.topLeft.y, this.boundingRect.topLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.topRight.x, this.boundingRect.topRight.y, this.boundingRect.topRight.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.bottomLeft.x, this.boundingRect.bottomLeft.y, this.boundingRect.bottomLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(array, insertionIndex, this.boundingRect.bottomLeft.x, this.boundingRect.bottomLeft.y, this.boundingRect.bottomLeft.z);
...
var Octogon = (function (_super) {
    ...
    Octogon.prototype.computeVerticies = function () {
        ...
        var rightTopThird = rightThirds.first;
        var rightBottomThird = rightThirds.second;
        var bottomLeftThird = bottomThirds.first;
        var bottomRightThird = bottomThirds.second;
        var leftTopThird = leftThirds.first;
        var leftBottomThird = leftThirds.second;
        var insertionIndex = 0;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, leftTopThird.x, leftTopThird.y, leftTopThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topLeftThird.x, topLeftThird.y, topLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, leftBottomThird.x, leftBottomThird.y, leftBottomThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, leftBottomThird.x, leftBottomThird.y, leftBottomThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topLeftThird.x, topLeftThird.y, topLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, bottomLeftThird.x, bottomLeftThird.y, bottomLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, bottomLeftThird.x, bottomLeftThird.y, bottomLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topLeftThird.x, topLeftThird.y, topLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, bottomRightThird.x, bottomRightThird.y, bottomRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topLeftThird.x, topLeftThird.y, topLeftThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, bottomRightThird.x, bottomRightThird.y, bottomRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topRightThird.x, topRightThird.y, topRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topRightThird.x, topRightThird.y, topRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, bottomRightThird.x, bottomRightThird.y, bottomRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, rightBottomThird.x, rightBottomThird.y, rightBottomThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, topRightThird.x, topRightThird.y, topRightThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, rightBottomThird.x, rightBottomThird.y, rightBottomThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this.addXYZAndColorToFloat32Array(arr, insertionIndex, rightTopThird.x, rightTopThird.y, rightTopThird.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        this._verticies = new float32Vector_1.Float32Vector(arr, arr.length);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var renderModeMapper_1 = __webpack_require__(15);
var vertexBuffer_1 = __webpack_require__(16);
var camera_1 = __webpack_require__(5);
var settings_1 = __webpack_require__(0);
var WebGLRenderer = (function () {
    function WebGLRenderer(canvasWidth, canvasHeight, gl, drawingSettings, camera) {
        if (drawingSettings === void 0) { drawingSettings = null; }
        if (camera === void 0) { camera = null; }
        this._vertexShaderSource = "   attribute vec4 " + settings_1.ShaderSettings.positionAttributeName + ";\n    attribute vec4 " + settings_1.ShaderSettings.colorAttributeName + ";\n    uniform mat4 " + settings_1.ShaderSettings.viewMatrixUniformName + ";\n    uniform float " + settings_1.ShaderSettings.pointSizeUniformName + ";\n    varying vec4 v_color;\n    void main(void)\n    {\n        gl_Position = " + settings_1.ShaderSettings.viewMatrixUniformName + " * " + settings_1.ShaderSettings.positionAttributeName + ";\n        gl_PointSize = " + settings_1.ShaderSettings.pointSizeUniformName + ";\n        v_color = " + settings_1.ShaderSettings.colorAttributeName + ";\n    }";
    ...
    WebGLRenderer.prototype.addShapeToScene = function (shape) {
        var vertexIndex = 0;
        for (var i = 0; i < shape.verticies.length; i += settings_1.Settings.floatsPerVertex) {
    ...
    WebGLRenderer.prototype.initializeDrawingSettings = function (drawingSettings) {
        this._renderMode = (drawingSettings && drawingSettings.renderMode) || settings_1.Settings.defaultRendereMode;
        this._glRenderMode = renderModeMapper_1.RenderModeMapper.renderModeToWebGlConstant(this._renderMode, this.gl);
        this._pointSize = (drawingSettings && drawingSettings.pointSize) || settings_1.Settings.defaultPointSize;
        this._backgroundColor = (drawingSettings && drawingSettings.backgroundColor) || settings_1.Settings.defaultBackgroundColor;
    };
    ...
    WebGLRenderer.prototype.drawGlArray = function (arr, renderMode) {
        var a_position = this.gl.getAttribLocation(this._shaderProgram, settings_1.ShaderSettings.positionAttributeName);
        var a_color = this.gl.getAttribLocation(this._shaderProgram, settings_1.ShaderSettings.colorAttributeName);
        var u_pointSize = this.gl.getUniformLocation(this._shaderProgram, settings_1.ShaderSettings.pointSizeUniformName);
        var u_viewMatrix = this.gl.getUniformLocation(this._shaderProgram, settings_1.ShaderSettings.viewMatrixUniformName);
        if (!u_pointSize || !u_viewMatrix) {
            var uniformsMap = {};
            uniformsMap[settings_1.ShaderSettings.pointSizeUniformName] = u_pointSize;
            uniformsMap[settings_1.ShaderSettings.viewMatrixUniformName] = u_viewMatrix;
...
var VertexBuffer = (function () {
    function VertexBuffer(glRenderMode, gl) {
        if (this.glRenderModeValidator(glRenderMode, gl)) {
            ...
            this._topVertexVector = new float32Vector_1.Float32Vector(new Float32Array(0), settings_1.Settings.vertexBufferFloatLimit);
    ...
    VertexBuffer.prototype.addVertex = function (vertex) {
        if (vertex.length !== settings_1.Settings.floatsPerVertex) {
            throw "cannot add vertex repersented by " + vertex.length + " floats, " +
                ("we only accept verticies of " + settings_1.Settings.floatsPerVertex + " floats (x, y, z, r, g, b)");
        }
        if (this._topVertexVector.size + vertex.length <= settings_1.Settings.vertexBufferFloatLimit) {
            ...
            this._topVertexVector = new float32Vector_1.Float32Vector(vertex, settings_1.Settings.vertexBufferFloatLimit);
            this.verticiesStack.push(this._topVertexVector);
        }
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var browserHelper_1 = __webpack_require__(19);
var ContextWrangler = (function () {
    function ContextWrangler() {
    }
    ContextWrangler.getContext = function (canvas, browserHelper) {
        if (browserHelper === void 0) { browserHelper = new browserHelper_1.BrowserHelper(); }
        var gl;
        var isIE = browserHelper.isIE();
        var isEdge = browserHelper.isEdge();
...
var Line = (function (_super) {
    ...
    Line.prototype.computeVerticies = function () {
        var arr = new Float32Array(this._vertexPositions.length * settings_1.Settings.floatsPerVertex);
...
var Point = (function (_super) {
    ...
    Point.prototype.computeVerticies = function () {
        var vertex = new Float32Array(settings_1.Settings.floatsPerVertex);
