...
var WebGLRenderer = (function () {
    function WebGLRenderer(canvas, renderingOptions, postResizeCalllback) {
        ...
        this.calcWidth = function (newWidth) {
            return newWidth;
        };
        this.calcHeight = function (newHeight) {
            return newHeight;
        };
        this.resizeCanvas = function (canvas, window, renderer) {
            var newWidth = _this.calcWidth(window.innerWidth);
            var newHeight = _this.calcHeight(window.innerHeight);
...
var WebGL3dRenderer = (function (_super) {
    ...
    function WebGL3dRenderer(canvas, renderingOptions) {
        if (renderingOptions === void 0) { renderingOptions = {}; }
        var _this = this;
        var postResize = function (leCanvas, window, renderer) {
            renderer.camera.aspectRatio = (_this._canvas.width / _this._canvas.height);
        };
        _this = _super.call(this, canvas, renderingOptions, postResize) || this;
