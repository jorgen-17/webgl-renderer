...
var Camera = (function () {
    function Camera() {
        this._modelMatrix = new cuon_matrix_ts_1.Mat4();
        this._modelMatrix.setIdentity();
    }
    Object.defineProperty(Camera.prototype, "modelMatrix", {
        get: function () {
...
var defaultGpuMemoryEffeciency = false;
exports.Settings = {
...
var colorMapper_1 = __webpack_require__(21);
...
Object.defineProperty(exports, "__esModule", { value: true });
var renderModeMapper_1 = __webpack_require__(5);
...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.drawGlArray = function (arr, renderMode) {
        ...
        var u_modelMatrix = this.gl.getUniformLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.modelMatrixUniformName);
        if (!u_pointSize || !u_modelMatrix) {
            var uniformsMap = {};
            uniformsMap[shaderSettings_1.ShaderSettings.pointSizeUniformName] = u_pointSize;
            uniformsMap[shaderSettings_1.ShaderSettings.modelMatrixUniformName] = u_modelMatrix;
