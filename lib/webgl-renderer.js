...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.drawShapeBuffer = function (shapeBuffer) {
        ...
        var floatsPerRow = constants_1.Constants.floatsPerMat4Row;
        ...
        this.gl.vertexAttribPointer(this._a_modelMatrixRow0, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow0Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow0);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow1, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow1Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow1);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow2, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow2Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow2);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow3, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow3Offset);
