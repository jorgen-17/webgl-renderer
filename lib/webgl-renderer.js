...
Object.defineProperty(exports, "__esModule", { value: true });
var cuon_matrix_ts_1 = __webpack_require__(2);
var boundingRectangle_1 = __webpack_require__(10);
var constants_1 = __webpack_require__(0);
var settings_1 = __webpack_require__(5);
var Shape = (function () {
    function Shape(rgbColor, point1, point2) {
    ...
    Shape.prototype.addXYZAndColorToFloat32Array = function (array, index, x, y, z) {
        array[index] = x;
        array[index + 1] = y;
        array[index + 2] = z;
    ...
    Shape.prototype.addTriangleToFloat32Array = function (array, index, vertex1Position, vertex2Position, vertex3Position) {
...
var precision_1 = __webpack_require__(12);
var constants_1 = __webpack_require__(0);
...
var Box = (function (_super) {
    ...
    function Box(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, rgbColor, point1, point2) || this;
        var length = _this.boundingRect.topRight.x - _this.boundingRect.topLeft.x;
        var height = _this.boundingRect.topRight.y - _this.boundingRect.bottomRight.y;
        var depth = Math.min(length, height);
        _this._backFaceZ = _this.boundingRect.bottomLeft.z + depth;
        _this.computeVerticies();
        _this.glRenderMode = gl.TRIANGLES;
        return _this;
    }
    Box.prototype.computeVerticies = function () {
        var array = new Float32Array(Box.numberOfVerticies * constants_1.Constants.floatsPerVertex);
        var insertionIndex = 0;
        this.addTriangleToFloat32Array(array, insertionIndex, this.boundingRect.topLeft, this.boundingRect.topRight, this.boundingRect.bottomLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, this.boundingRect.bottomLeft, this.boundingRect.topRight, this.boundingRect.bottomRight);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        var rightFaceRect = new boundingRectangle_1.BoundingRectangle(this.boundingRect.topRight, new cuon_matrix_ts_1.Vec3(this.boundingRect.bottomRight.x, this.boundingRect.bottomRight.y, this._backFaceZ));
        this.addTriangleToFloat32Array(array, insertionIndex, rightFaceRect.topLeft, rightFaceRect.topRight, rightFaceRect.bottomLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, rightFaceRect.bottomLeft, rightFaceRect.topRight, rightFaceRect.bottomRight);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        var leftFaceRect = new boundingRectangle_1.BoundingRectangle(this.boundingRect.topLeft, new cuon_matrix_ts_1.Vec3(this.boundingRect.bottomLeft.x, this.boundingRect.bottomLeft.y, this._backFaceZ));
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.topLeft, leftFaceRect.topRight, leftFaceRect.bottomLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.bottomLeft, leftFaceRect.topRight, leftFaceRect.bottomRight);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.topRight, rightFaceRect.topRight, leftFaceRect.bottomRight);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.bottomRight, rightFaceRect.topRight, rightFaceRect.bottomRight);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.topRight, rightFaceRect.topRight, leftFaceRect.topLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.topLeft, rightFaceRect.topRight, rightFaceRect.topLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.bottomRight, rightFaceRect.bottomRight, leftFaceRect.bottomLeft);
        insertionIndex += constants_1.Constants.floatsPerTriangle;
        this.addTriangleToFloat32Array(array, insertionIndex, leftFaceRect.bottomLeft, rightFaceRect.bottomRight, rightFaceRect.bottomLeft);
        this._verticies = new float32Vector_1.Float32Vector(array, array.length);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var webglRenderer_1 = __webpack_require__(19);
...
var hexagon_1 = __webpack_require__(15);
exports.Hexagon = hexagon_1.Hexagon;
var octogon_1 = __webpack_require__(16);
exports.Octogon = octogon_1.Octogon;
var triangle_1 = __webpack_require__(13);
...
var mouseHelper_1 = __webpack_require__(26);
...
var vertexBuffer_1 = __webpack_require__(20);
var camera_1 = __webpack_require__(7);
var constants_1 = __webpack_require__(0);
var shaderSettings_1 = __webpack_require__(21);
var settings_1 = __webpack_require__(5);
var browserHelper_1 = __webpack_require__(8);
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.draw = function () {
        ...
        if (this._shapeScene.length > 0) {
            for (var _d = 0, _e = this._shapeScene; _d < _e.length; _d++) {
                var shape = _e[_d];
    ...
    WebGLRenderer.prototype.drawGlArray = function (arr, renderMode, modelMatrix) {
        if (modelMatrix === void 0) { modelMatrix = settings_1.Settings.defaultModelMatrix; }
        ...
        var u_mvpMatrix = this.gl.getUniformLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.mvpMatrixUniformName);
        if (!u_pointSize || !u_mvpMatrix) {
            var uniformsMap = {};
            uniformsMap[shaderSettings_1.ShaderSettings.pointSizeUniformName] = u_pointSize;
            uniformsMap[shaderSettings_1.ShaderSettings.mvpMatrixUniformName] = u_mvpMatrix;
...
var VertexBuffer = (function () {
    function VertexBuffer(glRenderMode, gl, vectorSizeLimit) {
        ...
        if (this.glRenderModeValidator(glRenderMode, gl)) {
            ...
            var initialVector = this._vectorSizeLimit ?
...
var ShapeFactory = (function () {
    ...
    ShapeFactory.createShape2d = function (point1, point2, shape2dMode, gl, rgbColor) {
        switch (shape2dMode) {
            case "triangles":
    ...
    ShapeFactory.createShape3d = function (point1, point2, shape3dMode, gl, rgbColor) {
        switch (shape3dMode) {
            case "box":
...
var Line = (function (_super) {
    ...
    function Line(point, gl, rgbColor) {
        ...
        _this.computeVerticies();
        _this.glRenderMode = renderModeMapper_1.RenderModeMapper.renderModeToWebGlConstant("lineStrip", gl);
        return _this;
    }
