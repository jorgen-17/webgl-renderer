...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.drawShapeBuffer = function (shapeBuffer) {
        ...
        var modelMatrixRow0Offset = bytesPerRow * 0;
        var modelMatrixRow1Offset = bytesPerRow * 1;
        var modelMatrixRow2Offset = bytesPerRow * 2;
        var modelMatrixRow3Offset = bytesPerRow * 3;
        ...
        this.gl.vertexAttribPointer(this._a_modelMatrixRow0, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow0);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow1, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow1);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow2, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow2);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow3, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
