...
var Camera = (function () {
    ...
    Camera.prototype.moveLeft = function (moveAmount) {
        if (moveAmount === void 0) { moveAmount = 0.01; }
        var direction = new cuon_matrix_ts_1.Vec3((this._lookAtPoint.x - this._eyePosition.x) * moveAmount, (this._lookAtPoint.y - this._eyePosition.y) * moveAmount, (this._lookAtPoint.z - this._eyePosition.z) * moveAmount);
        var left = this.rotateVector(direction, Math.PI / 2, 'y');
        this._eyePosition = new cuon_matrix_ts_1.Vec3(this._eyePosition.x + left.x, this._eyePosition.y, this._eyePosition.z + left.z);
        this._lookAtPoint = new cuon_matrix_ts_1.Vec3(this._lookAtPoint.x + left.x, this._lookAtPoint.y, this._lookAtPoint.z + left.z);
        this.updateView();
    };
    Camera.prototype.moveRight = function (moveAmount) {
        if (moveAmount === void 0) { moveAmount = 0.01; }
        var direction = new cuon_matrix_ts_1.Vec3((this._lookAtPoint.x - this._eyePosition.x) * moveAmount, (this._lookAtPoint.y - this._eyePosition.y) * moveAmount, (this._lookAtPoint.z - this._eyePosition.z) * moveAmount);
        var right = this.rotateVector(direction, -Math.PI / 2, 'y');
        this._eyePosition = new cuon_matrix_ts_1.Vec3(this._eyePosition.x + right.x, this._eyePosition.y, this._eyePosition.z + right.z);
        this._lookAtPoint = new cuon_matrix_ts_1.Vec3(this._lookAtPoint.x + right.x, this._lookAtPoint.y, this._lookAtPoint.z + right.z);
        this.updateView();
    };
