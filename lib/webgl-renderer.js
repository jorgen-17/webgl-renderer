...
Object.defineProperty(exports, "__esModule", { value: true });
var vec3_1 = __webpack_require__(3);
var BoundingRectangle = (function () {
    function BoundingRectangle(point1, point2) {
        if (this.isTopLeftBottomRight(point1, point2)) {
            this.topLeft = point1;
            this.topRight = new vec3_1.Vec3(point2.x, point1.y, point2.z);
            this.bottomRight = point2;
            this.bottomLeft = new vec3_1.Vec3(point1.x, point2.y, point1.z);
        }
        else if (this.isBottomRightTopLeft(point1, point2)) {
            this.topLeft = point2;
            this.topRight = new vec3_1.Vec3(point1.x, point2.y, point1.z);
            this.bottomRight = point1;
            this.bottomLeft = new vec3_1.Vec3(point2.x, point1.y, point2.z);
        }
        else if (this.isBottomLeftTopRight(point1, point2)) {
            this.topLeft = new vec3_1.Vec3(point1.x, point2.y, point1.z);
            this.topRight = point2;
            this.bottomRight = new vec3_1.Vec3(point2.x, point1.y, point2.z);
            this.bottomLeft = point1;
        }
        else {
            this.topLeft = new vec3_1.Vec3(point2.x, point1.y, point2.z);
            this.topRight = point1;
            this.bottomRight = new vec3_1.Vec3(point1.x, point2.y, point1.z);
...
var Midpoint = (function () {
    ...
    Midpoint.between = function (point1, point2) {
        ...
        return new vec3_1.Vec3(midX, midY, midZ);
    };
    return Midpoint;
}());
...
var ThirdPoints = (function () {
    ...
    ThirdPoints.between = function (point1, point2) {
        ...
        var firstThird = new vec3_1.Vec3((smallerX + thirdX), (smallerY + thirdY), (smallerZ + thirdZ));
        var secondThird = new vec3_1.Vec3((firstThird.x + thirdX), (firstThird.y + thirdY), (firstThird.z + thirdZ));
...
Object.defineProperty(exports, "__esModule", { value: true });
var mat4_1 = __webpack_require__(19);
var vec3_1 = __webpack_require__(3);
var Camera = (function () {
    function Camera(eyePosition, lookAtPoint, upPosition) {
        ...
        this._viewMatrix = new mat4_1.Mat4();
    ...
    Camera.prototype.translateEyePosition = function (eyePosition) {
        var newLookAtPoint = new vec3_1.Vec3(eyePosition.x, eyePosition.y, eyePosition.z - 1);
        var newUpPosition = new vec3_1.Vec3(eyePosition.x, eyePosition.y + 1, eyePosition.z);
...
var boundingRectangle_1 = __webpack_require__(4);
...
var Ellipse = (function (_super) {
    ...
    Ellipse.prototype.populateVerticies = function (boundingRect) {
        ...
        var symmetryInsertionOffset = ((this.numberOfInnerVerticies / 2) * settings_1.Settings.floatsPerVertex) + settings_1.Settings.floatsPerVertex;
    ...
    Ellipse.highPrecisionNumberOfInnerVerticies = 8;
    Ellipse.highPrecisionNumberOfVerticies = Ellipse.highPrecisionNumberOfInnerVerticies + 3;
    Ellipse.lowPrecisionNumberOfInnerVerticies = 400;
...
var Triangle = (function (_super) {
    ...
    function Triangle(point1, point2, rgbColor, gl) {
        ...
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.bottomLeft.x, boundingRect.bottomLeft.y, boundingRect.bottomLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, topPoint.x, topPoint.y, topPoint.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.bottomRight.x, boundingRect.bottomRight.y, boundingRect.bottomRight.z);
...
var Rectangle = (function (_super) {
    ...
    function Rectangle(point1, point2, rgbColor, gl) {
        ...
        var insertionIndex = 0;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.topLeft.x, boundingRect.topLeft.y, boundingRect.topLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.topRight.x, boundingRect.topRight.y, boundingRect.topRight.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.bottomLeft.x, boundingRect.bottomLeft.y, boundingRect.bottomLeft.z);
        insertionIndex += settings_1.Settings.floatsPerVertex;
        _this.addXYAndColorToFloat32Array(array, insertionIndex, boundingRect.bottomRight.x, boundingRect.bottomRight.y, boundingRect.bottomRight.z);
...
var contextWrangler_1 = __webpack_require__(21);
...
var shapeFactory_1 = __webpack_require__(24);
...
var point3d_1 = __webpack_require__(25);
...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.initializeCamera = function (camera) {
        if (camera) {
            ...
            var eyePosition = new vec3_1.Vec3(0, 0, 0);
            var lookAtPoint = new vec3_1.Vec3(0, 0, -1);
            var upPosition = new vec3_1.Vec3(0, 1, 0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var vec3_1 = __webpack_require__(3);
var vec4_1 = __webpack_require__(20);
var Mat4 = (function () {
...
var Line = (function (_super) {
    ...
    function Line(point, rgbColor, gl) {
        ...
        _this.addXYAndColorToFloat32Array(array, 0, point.x, point.y, point.z);
        _this.verticies = new vector_1.Float32Vector(array);
