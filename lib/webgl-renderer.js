...
var defaultFar = 2;
var defaultMovementSpeed = 0.01;
var defaultLookSensitivity = 0.1;
...
var settings_1 = __webpack_require__(4);
var Camera = (function () {
    function Camera(aspectRatio, fieldOfView, near, far, eyePosition, lookAtPoint, upPosition, movementSpeed, lookSensitivity) {
        ...
        if (movementSpeed === void 0) { movementSpeed = settings_1.Settings.defaultMovementSpeed; }
        if (lookSensitivity === void 0) { lookSensitivity = settings_1.Settings.defaultLookSensitivity; }
    ...
    Object.defineProperty(Camera.prototype, "movementSpeed", {
        get: function () {
    ...
    Object.defineProperty(Camera.prototype, "lookSensitivity", {
        get: function () {
    ...
    Camera.prototype.panX = function (xOffset) {
        if (xOffset === void 0) { xOffset = this._movementSpeed; }
    ...
    Camera.prototype.panY = function (yOffset) {
        if (yOffset === void 0) { yOffset = this._movementSpeed; }
    ...
    Camera.prototype.zoomIn = function (zOffset) {
        if (zOffset === void 0) { zOffset = this._movementSpeed; }
    ...
    Camera.prototype.moveForward = function (moveAmount) {
        if (moveAmount === void 0) { moveAmount = this._movementSpeed; }
    ...
    Camera.prototype.rotatePitch = function (yOffset) {
        var yRadians = yOffset * (Math.PI / 180);
        var maxAngleUp = this._upPosition.angle(this._lookAtPoint);
        maxAngleUp -= 0.001;
        if (yRadians > maxAngleUp)
            yRadians = maxAngleUp;
        var maxAngleDown = cuon_matrix_ts_1.Vec3.negate(this._upPosition).angle(this._lookAtPoint);
        maxAngleDown *= -1;
        maxAngleDown += 0.001;
        if (yRadians < maxAngleDown)
            yRadians = maxAngleDown;
        yRadians *= this._lookSensitivity;
        var rotatedDirection = cuon_matrix_ts_1.Vec3.rotate(this.forward, this.right, yRadians);
        this._lookAtPoint = cuon_matrix_ts_1.Vec3.add(this._eyePosition, rotatedDirection);
        this.updateView();
    };
    Camera.prototype.rotateYaw = function (xOffset) {
        var xRadians = xOffset * (Math.PI / 180);
        xRadians *= this._lookSensitivity;
        var rotatedDirection = this.forward.rotate(this.up, xRadians);
        this._lookAtPoint = cuon_matrix_ts_1.Vec3.add(this._eyePosition, rotatedDirection);
        this.updateView();
    };
