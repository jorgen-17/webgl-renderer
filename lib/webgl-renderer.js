...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.getShaderVariables = function () {
        ...
        this._a_modelMatrix = this.gl.getAttribLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.modelMatrixAttributeName);
    ...
    WebGLRenderer.prototype.drawShapeBuffer = function (shapeBuffer) {
        ...
        this.gl.vertexAttribPointer(this._a_modelMatrix, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
