...
var WebGLRenderer = (function () {
    function WebGLRenderer(canvas, browserHelper, leWindow, drawingSettings, camera) {
        if (browserHelper === void 0) { browserHelper = new browserHelper_1.BrowserHelper(); }
        if (leWindow === void 0) { leWindow = null; }
        ...
        this.resizeCanvas = function () {
            _this.setViewPortDimensions(_this._window.innerWidth, _this._window.innerHeight);
            _this._canvas.width = _this._window.innerWidth;
            _this._canvas.height = _this._window.innerHeight;
        };
        this._canvas = canvas;
    ...
    WebGLRenderer.prototype.getContext = function (canvas, browserHelper) {
        var gl;
    ...
    WebGLRenderer.prototype.initializeDrawingSettings = function (drawingSettings) {
        ...
        this._isFullscreen = (drawingSettings && drawingSettings.fullscreen) || settings_1.Settings.defaultIsFullScreen;
    };
    ...
    WebGLRenderer.prototype.setupWindowCallbacks = function () {
        ...
        if (this._isFullscreen) {
            this._window.addEventListener("resize", function () { _this.resizeCanvas(); }, false);
            this.resizeCanvas();
        }
    };
