...
var Camera = (function () {
    ...
    Camera.prototype.moveLeft = function (moveAmount) {
        ...
        this._eyePosition = this._eyePosition = new cuon_matrix_ts_1.Vec3(this._eyePosition.x + left.x, this._eyePosition.y, this._eyePosition.z + left.z);
        this._lookAtPoint = this._lookAtPoint = new cuon_matrix_ts_1.Vec3(this._lookAtPoint.x + left.x, this._lookAtPoint.y, this._lookAtPoint.z + left.z);
        this.updateView();
    };
    Camera.prototype.moveRight = function (moveAmount) {
        ...
        this._eyePosition = this._eyePosition = new cuon_matrix_ts_1.Vec3(this._eyePosition.x + right.x, this._eyePosition.y, this._eyePosition.z + right.z);
        this._lookAtPoint = this._lookAtPoint = new cuon_matrix_ts_1.Vec3(this._lookAtPoint.x + right.x, this._lookAtPoint.y, this._lookAtPoint.z + right.z);
        this.updateView();
    };
    ...
    Camera.prototype.rotateView = function (xOffset, yOffset) {
        ...
        var direction = new cuon_matrix_ts_1.Vec3(this._lookAtPoint.x - this._eyePosition.x, this._lookAtPoint.y - this._eyePosition.y, this._lookAtPoint.z - this._eyePosition.z);
        var rotatedDirection = this.rotateVector(direction, xRadians, 'y');
