...
var WebGLRenderer = (function () {
    function WebGLRenderer(canvas, renderingOptions) {
        ...
        this.resizeCanvasBase = function (canvas, window, renderer) {
...
var WebGL2dRenderer = (function (_super) {
    ...
    function WebGL2dRenderer(canvas, renderingOptions) {
        ...
        _this.resizeCanvas = function (leCanvas, window, renderer) {
            _this.resizeCanvasBase(leCanvas, window, renderer);
        };
        return _this;
    }
