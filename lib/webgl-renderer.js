...
var bytesPerVertex = floatSize * floatsPerVertex;
var bytesPerPoint = floatSize * floatsPerPoint;
var bytesPerColor = floatSize * floatsPerPoint;
...
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.drawShapeBuffer = function (shapeBuffer) {
        ...
        this.gl.vertexAttribPointer(this._a_position, constants_1.Constants.floatsPerPoint, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, 0);
        this.gl.enableVertexAttribArray(this._a_position);
        this.gl.vertexAttribPointer(this._a_color, constants_1.Constants.floatsPerColor, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, constants_1.Constants.bytesPerPoint);
        this.gl.enableVertexAttribArray(this._a_color);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow0, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, constants_1.Constants.modelMatrixRow0Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow0);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow1, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, constants_1.Constants.modelMatrixRow1Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow1);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow2, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, constants_1.Constants.modelMatrixRow2Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow2);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow3, constants_1.Constants.floatsPerMat4Row, this.gl.FLOAT, false, constants_1.Constants.bytesPerVertex, constants_1.Constants.modelMatrixRow3Offset);
