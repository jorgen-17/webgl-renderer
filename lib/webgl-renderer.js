...
var floatsPerRowOfMat4 = 16;
var floatsPerMat4 = 16;
var floatsPerVertex = floatsPerPoint + floatsPerColor + floatsPerMat4;
var floatsPerTriangle = verticiesPerTriangle * floatsPerPoint;
exports.Constants = {
...
var boundingRectangle_1 = __webpack_require__(9);
var constants_1 = __webpack_require__(1);
var settings_1 = __webpack_require__(4);
var Shape = (function () {
    function Shape(numberOfVerticies, rgbColor, point1, point2) {
        ...
        this._verticies = new Float32Array(numberOfVerticies * constants_1.Constants.floatsPerVertex);
    ...
    Object.defineProperty(Shape.prototype, "modelMatrix", {
        get: function () {
    ...
    Shape.prototype.addXYZColorAndModelMatToVerticies = function (index, x, y, z) {
    ...
    Shape.prototype.addTriangleToVerticies = function (index, vertex1Position, vertex2Position, vertex3Position) {
        this.addXYZColorAndModelMatToVerticies(index, vertex1Position.x, vertex1Position.y, vertex1Position.z);
        this.addXYZColorAndModelMatToVerticies((index + constants_1.Constants.floatsPerVertex), vertex2Position.x, vertex2Position.y, vertex2Position.z);
        this.addXYZColorAndModelMatToVerticies((index + (constants_1.Constants.floatsPerVertex * 2)), vertex3Position.x, vertex3Position.y, vertex3Position.z);
    };
    return Shape;
}());
exports.Shape = Shape;
...
var Camera = (function () {
    ...
    Camera.prototype.panX = function (xOffset) {
        ...
        this._upPosition = new cuon_matrix_ts_1.Vec3(this._eyePosition.x, this._eyePosition.y + 1, this._eyePosition.z);
        this.updateView();
    };
...
var float32ArrayUtils_1 = __webpack_require__(31);
...
var Ellipse = (function (_super) {
    ...
    function Ellipse(point1, point2, gl, precision, rgbColor) {
        ...
        var _this = _super.call(this, precision === precision_1.Precision.High ? Ellipse.highPrecisionNumberOfVerticies :
            Ellipse.lowPrecisionNumberOfVerticies, rgbColor, point1, point2) || this;
...
var Triangle = (function (_super) {
    ...
    function Triangle(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, Triangle.numberOfVerticies, rgbColor, point1, point2) || this;
...
var Rectangle = (function (_super) {
    ...
    function Rectangle(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, Rectangle.numberOfVerticies, rgbColor, point1, point2) || this;
...
var Hexagon = (function (_super) {
    ...
    function Hexagon(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, Hexagon.numberOfVerticies, rgbColor, point1, point2) || this;
...
var Octogon = (function (_super) {
    ...
    function Octogon(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, Octogon.numberOfVerticies, rgbColor, point1, point2) || this;
...
var Box = (function (_super) {
    ...
    function Box(point1, point2, gl, rgbColor) {
        var _this = _super.call(this, Box.numberOfVerticies, rgbColor, point1, point2) || this;
        _this.shapeMode = "box";
...
Object.defineProperty(exports, "__esModule", { value: true });
var renderModeMapper_1 = __webpack_require__(19);
var camera_1 = __webpack_require__(5);
var constants_1 = __webpack_require__(1);
var shaderSettings_1 = __webpack_require__(20);
var settings_1 = __webpack_require__(4);
var browserHelper_1 = __webpack_require__(6);
var shapeBuffer_1 = __webpack_require__(21);
var WebGLRenderer = (function () {
    ...
    WebGLRenderer.prototype.draw = function () {
        ...
        for (var _i = 0, _a = this._shapeBuffers; _i < _a.length; _i++) {
            var sb = _a[_i];
            if (sb.count > 0) {
    ...
    WebGLRenderer.prototype.initializaShapeBuffers = function () {
        this._trianglesShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._rectanglesShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._hexagonsShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._octogonsShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._ellipsesShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._boxShapeBuffer = new shapeBuffer_1.ShapeBuffer();
        this._shapeBuffers = [
    ...
    WebGLRenderer.prototype.getShaderVariables = function () {
        this._a_position = this.gl.getAttribLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.positionAttributeName);
        this._a_color = this.gl.getAttribLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.colorAttributeName);
        this._a_modelMatrixRow0 = this.gl.getAttribLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.modelMatrixAttributeName);
        ...
        this._u_pointSize = this.gl.getUniformLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.pointSizeUniformName);
        this._u_vpMatrix = this.gl.getUniformLocation(this._shaderProgram, shaderSettings_1.ShaderSettings.vpMatrixUniformName);
    };
    WebGLRenderer.prototype.drawShapeBuffer = function (shapeBuffer) {
        if (!this._u_pointSize || !this._u_vpMatrix) {
            var uniformsMap = {};
            uniformsMap[shaderSettings_1.ShaderSettings.pointSizeUniformName] = this._u_pointSize;
        ...
        var floatSize = verticies.BYTES_PER_ELEMENT;
        var bytesPerPoint = floatSize * constants_1.Constants.floatsPerPoint;
        var bytesPerColor = floatSize * constants_1.Constants.floatsPerPoint;
        var bytesPerPointColor = bytesPerPoint + bytesPerColor;
        var bytesPerVertex = floatSize * constants_1.Constants.floatsPerVertex;
        var floatsPerRow = constants_1.Constants.floatsPerRowOfMat4;
        var bytesPerRow = floatsPerRow * floatSize;
        var bytesPerMatrix = bytesPerRow * floatSize;
        var modelMatrixRow0Offset = bytesPerPointColor + (bytesPerRow * 0);
        var modelMatrixRow1Offset = bytesPerPointColor + (bytesPerRow * 1);
        var modelMatrixRow2Offset = bytesPerPointColor + (bytesPerRow * 2);
        var modelMatrixRow3Offset = bytesPerPointColor + (bytesPerRow * 3);
        ...
        this.gl.vertexAttribPointer(this._a_position, constants_1.Constants.floatsPerPoint, this.gl.FLOAT, false, bytesPerVertex, 0);
        this.gl.enableVertexAttribArray(this._a_position);
        this.gl.vertexAttribPointer(this._a_color, constants_1.Constants.floatsPerColor, this.gl.FLOAT, false, bytesPerVertex, bytesPerPoint);
        this.gl.enableVertexAttribArray(this._a_color);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow0, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow0Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow0);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow1, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow1Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow1);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow2, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow2Offset);
        this.gl.enableVertexAttribArray(this._a_modelMatrixRow2);
        this.gl.vertexAttribPointer(this._a_modelMatrixRow3, constants_1.Constants.floatsPerMat4, this.gl.FLOAT, false, bytesPerVertex, modelMatrixRow3Offset);
        ...
        this.gl.drawArrays(shapePrototype.glRenderMode, 0, (verticies.length / constants_1.Constants.floatsPerVertex));
...
var ShapeBuffer = (function () {
    ...
    ShapeBuffer.prototype.removeShape = function (id) {
        if (this._shapes.hasOwnProperty(id)) {
            ...
            var verticiesCount = shape.numberOfVerticies * constants_1.Constants.floatsPerVertex;
...
module.exports = exports = __webpack_require__(30);
...
var Line = (function (_super) {
    ...
    function Line(point, gl, rgbColor) {
        var _this = _super.call(this, 1, rgbColor) || this;
    ...
    Line.prototype.computeVerticies = function () {
        var arr = new Float32Array(this._vertexPositions.length *
            (constants_1.Constants.floatsPerPoint + constants_1.Constants.floatsPerColor));
        for (var i = 0; i < this._vertexPositions.length; i++) {
            var insertionIndex = i * constants_1.Constants.floatsPerPoint;
    ...
    Line.prototype.addVertex = function (vertex) {
        ...
        var array = new Float32Array(constants_1.Constants.floatsPerPoint);
...
var Point = (function (_super) {
    ...
    function Point(location, gl, rgbColor) {
        var _this = _super.call(this, Point.numberOfVerticies, rgbColor) || this;
    ...
    Point.prototype.computeVerticies = function () {
        this.addXYZColorAndModelMatToVerticies(0, this._location.x, this._location.y, this._location.z);
    };
