...
var mouseHelper_1 = __webpack_require__(25);
...
var WebGLRenderer = (function () {
    ...
    Object.defineProperty(WebGLRenderer.prototype, "gpuMemoryEffeciency", {
        get: function () {
    ...
    WebGLRenderer.prototype.draw = function () {
        ...
        for (var _i = 0, _a = this._vertexBuffers; _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = vb.verticiesStack; _b < _c.length; _b++) {
                var verts = _c[_b];
                if (verts.size > 0) {
                    var verticies = this._gpuMemoryEffeciency ? verts.getTrimmedArray() : verts.arr;
    ...
    WebGLRenderer.prototype.initializeRenderingOptions = function (renderingOptions) {
        ...
        this._gpuMemoryEffeciency = (renderingOptions && renderingOptions.gpuMemoryEffeciency) || settings_1.Settings.defaultGpuMemoryEffeciency;
    };
