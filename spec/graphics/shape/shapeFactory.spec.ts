...
describe("shapeFactory:", () =>
{
    ...
    describe("createShape", () =>
    {
        it("creates triangle", () =>
        {
            ...
            expect(3 * Constants.floatsPerPoint).toBe(triangle.positions.length);
        ...
        it("creates rectangle", () =>
        {
            ...
            expect(6 * Constants.floatsPerPoint).toBe(rectangle.positions.length);
        ...
        it("creates hexagon", () =>
        {
            ...
            expect(12 * Constants.floatsPerPoint).toBe(hexagon.positions.length);
        ...
        it("creates octogon", () =>
        {
            ...
            expect(18 * Constants.floatsPerPoint).toBe(octogon.positions.length);
        ...
        it("creates ellipse", () =>
        {
            ...
            expect(1206 * Constants.floatsPerPoint).toBe(ellipse.positions.length);
        ...
        it("creates box", () =>
        {
            ...
            expect(36 * Constants.floatsPerPoint).toBe(box.positions.length);
