    ...
    describe("constructor:", () =>
    {
        ...
        describe("should initialize vertex positions and color correctly ", () =>
        {
            it("when constructed with point(0.5, 0.5) and point(1.0, 1.0)", () =>
            {
                ...
                // const expectedVerticies = WebglRendererTestHelper.concatMultipleFloat32Arrays([
                //     new Float32Array([0, 0, 0, orange.red, orange.green, orange.blue]),
                //     new Mat4().setIdentity().elements,
                //     new Float32Array([0.25, 0.5, 0, orange.red, orange.green, orange.blue]),
                //     new Mat4().setIdentity().elements,
                //     new Float32Array([0.5, 0, 0, orange.red, orange.green, orange.blue]),
                //     new Mat4().setIdentity().elements
                // ]);
